/* Extracts height and weight chartevent data, removing unnecessary columns to make the data file smaller */
select
...
from chartevents
where chartevents.itemid in (226707, 1394, 224639, 763);