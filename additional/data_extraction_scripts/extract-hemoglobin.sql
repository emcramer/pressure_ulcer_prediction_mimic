/* Extracts hematocrit chartevent data, removing unnecessary columns to make the data file smaller */
select
...
from chartevents
where chartevents.itemid = 814 or chartevents.itemid = 220228;