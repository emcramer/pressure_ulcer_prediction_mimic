/* Extracts glasgow coma scale chartevent data, removing unnecessary columns to make the data file smaller */
select
...
from chartevents
where chartevents.itemid in (198, 220739, 223900, 223901, 226756, 226757, 226758);